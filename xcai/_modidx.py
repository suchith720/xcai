...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'xcai.analysis': { 'xcai.analysis.CompareDataset': ('analysis.html#comparedataset', 'xcai/analysis.py'),
            ...
            'xcai.losses': { 'xcai.losses.BaseLoss': ('losses.html#baseloss', 'xcai/losses.py'),
                             ...
                             'xcai.losses.MultiRankingWithNegatives': ('losses.html#multirankingwithnegatives', 'xcai/losses.py'),
                             'xcai.losses.MultiRankingWithNegatives.forward': ( 'losses.html#multirankingwithnegatives.forward',
                                                                                'xcai/losses.py'),
                             'xcai.losses.MultiRankingWithNegativesFromScores': ( 'losses.html#multirankingwithnegativesfromscores',
                                                                                  'xcai/losses.py'),
                             'xcai.losses.MultiRankingWithNegativesFromScores.__init__': ( 'losses.html#multirankingwithnegativesfromscores.__init__',
                                                                                           'xcai/losses.py'),
                             'xcai.losses.MultiRankingWithNegativesFromScores.forward': ( 'losses.html#multirankingwithnegativesfromscores.forward',
                                                                                          'xcai/losses.py'),
