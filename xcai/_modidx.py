...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'xcai.analysis': { 'xcai.analysis.CompareDataset': ('analysis.html#comparedataset', 'xcai/analysis.py'),
            ...
            'xcai.losses': { 'xcai.losses.BaseLoss': ('losses.html#baseloss', 'xcai/losses.py'),
                             ...
                             'xcai.losses.PKMMultiTripletFromScores': ('losses.html#pkmmultitripletfromscores', 'xcai/losses.py'),
                             'xcai.losses.PKMMultiTripletFromScores.forward': ( 'losses.html#pkmmultitripletfromscores.forward',
                                                                                'xcai/losses.py'),
                             'xcai.losses.PKMMultiTripletFromScores.get_row_mask': ( 'losses.html#pkmmultitripletfromscores.get_row_mask',
                                                                                     'xcai/losses.py'),
