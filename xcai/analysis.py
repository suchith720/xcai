...
class TextDataset:
    ...
    def dump_json(self, fname:str, idxs:List):
        items = [self.combine_by_prefix(self[idx]) if self.combine_info else self[idx] for idx in idxs]
        with open(fname, 'w') as file:
