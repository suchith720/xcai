...
# %% auto 0
__all__ = ['BaseLoss', 'MultiCrossEntropy', 'MultiTriplet', 'Triplet', 'SoupCon']
...
def __call__(cls:Triplet, 
    ...
    ne = 1 - get_sparse_matrix(idx[len(inp2targ_idx_smp):], n_inp2targ).to_dense()[:, idx[:len(inp2targ_idx_smp)]]
    sc = inp@targ.T
