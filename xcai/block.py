...
# %% auto 0
__all__ = ['PARAM', 'CFGS', 'TFMS', 'wikiseealso', 'wikititles', 'amazontitles', 'XCBlock', 'prepare_batch']
...
class XCBlock:
    ...
    @classmethod
    def from_cfg(cls, data_dir:str, cfg:str, dset:Optional[str]='wikiseealso', bsz:Optional[int]=10, **kwargs):
