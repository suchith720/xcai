...
# %% auto 0
__all__ = ['BEIR_DATASETS', 'DATASETS', 'load_info', 'additional_args', 'get_random_idx', 'load_linker_block', 'linker_run',
           'linker_beir_inference', 'upma_beir_inference', 'load_upma_block', 'upma_run', 'early_fusion_run',
           'load_early_fusion_block', 'early_fusion_beir_inference']
...
def linker_beir_inference(output_dir:str, input_args:argparse.ArgumentParser, mname:str, 
                          save_file_name:str, meta_file:str):
    ...
    for dataset in BEIR_DATASETS:
        with open(f"{metric_dir}/{dataset}.json") as file:
            beir_metrics[dataset] = json.load(file)
...
def early_fusion_beir_inference(output_dir:str, input_args:argparse.ArgumentParser, mname:str, linker_dir:str):
    ...
    for dataset in tqdm(DATASETS):
        ...
        data_info = load_info(f"{input_args.pickle_dir}/{linker_dir}/{dataset}.joblib", 
                              f"/data/outputs/upma/{linker_dir}/raw_data/test_{dataset}.raw.csv", 
