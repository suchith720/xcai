...
def parse_args():
    ...
    parser.add_argument("--beir_metadata_mapping", action="store_true")
    parser.add_argument('--label_similarity', action="store_true")
...
def build_block(pkl_file:str, config:Union[str,Dict], use_sxc:Optional[bool]=True, config_key:Optional[str]=None, do_build:Optional[bool]=False, 
                ...
                ignore_lbl_info:Optional[bool]=False, ignore_neg_info:Optional[bool]=False, **kwargs):
